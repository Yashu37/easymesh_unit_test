...
void construct_get_first_tlv_pkt7_a_b_e2_rb_tlvs(void)
{
	*(uint16_t*)ptr = htons(0); ptr += 2;
...
void construct_get_first_tlv_pkt14_a_b_c2_rb_tlvs(void)
{
	// ---- C: TLV 0xCB
	*ptr++ = 0xCB;
	*ptr++ = 0x00;
...
void construct_get_first_tlv_pkt21_a_b_d2_rb_tlvs(void)
{
	*ptr++ = 0xCB;
	*ptr++ = 0x00;
}
...
pkt_test_case_t get_first_tlv_suite[] = {
	...
	{"get_first_tlv_pkt7_a_b_e2_rb",          "pkt7rb.pcap",  construct_get_first_tlv_pkt7_a_b_e2_rb_tlvs,         -1},
	...
	{"get_first_tlv_pkt14_a_b_c2_rb",         "pkt14rb.pcap", construct_get_first_tlv_pkt14_a_b_c2_rb_tlvs,        -1},
	...
	{"get_first_tlv_pkt21_a_b_d2_rb",         "pkt21rb.pcap", construct_get_first_tlv_pkt21_a_b_d2_rb_tlvs,        -1},
